namespace :accounts do
    ...
    task :update, [:hours] => [:environment] do |task, args|
        ...
        puts "Updating All Accounts with the last #{time_to_sync} hours of data"
            ...
            if monzo.is_authorised?
                while sync_account
                    ...
                    accounts.each do |account|
                        ...
                        transactions = monzo.get_transactions(account["id"], Time.new.ago(3600*time_to_sync).strftime('%FT%TZ'))
